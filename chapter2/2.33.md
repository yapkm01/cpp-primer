...
d = 42; // error: d is a pointer to int. Cannot assign an integer directly to int*
        // use *d = 42. if the value is an address, it must be explicitly done as below
        // int *ptr = (int*)0x7ffeefbff5c8
e = 42; // error: e is a pointer to a constant int; it cannot point to an int.
        // same explanation as in d but e is not allowed to make modification
